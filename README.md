# 3-in-1 AI Image Processing Model

This project was originally developed as an academic assignment for my AI course, but has since evolved into a streamlined, integrated application.

## System Overview
The application integrates three distinct computer vision models into a single, unified interface for convenience and efficiency:
- **YOLO** (Built by me)
- **CNN** (Built by me)
- **MobileNet** (Built by my teammate)

Rather than running three standalone models independently and dealing with the overhead, this project combines them into a seamless 3-in-1 experience. 
